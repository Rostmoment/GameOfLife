...
Clear – reset the grid<br>
Random – fill the grid with random cells (by slider above you can change percent of alive cells in random generation)<br>
Birth if – a dead cell becomes alive if it has this many neighbors (default: 3)<br>
Survive if – a live cell stays alive if it has this many neighbors (default: 2 or 3)<br>
Connect Top/Bottom, Left/Right – toggle edge wrapping<br>

# Simple rules - complicated behaviour of cells
